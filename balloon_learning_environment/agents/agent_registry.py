...
from balloon_learning_environment.agents import mpc_seeker_agent
...
from balloon_learning_environment.agents import mpc5_agent
...
REGISTRY = {
    ...
    'perciatelli_data_collector': (perciatelli44.Perciatelli44DataCollector, None),
    'distilled_perciatelli': (perciatelli44.DistilledPerciatelliAgent, None),
    ...
    'mpc-seeker': (mpc_seeker_agent.MPCSeekerAgent, None),
    ...
    'mpc5': (mpc5_agent.MPC5Agent, None),
